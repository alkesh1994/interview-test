...
class ApiController extends Controller
{
     ...
     * @return mixed
     */
    public function respondWithFields($message)
    {
        return $this->respond([
            'data' => $message,
            'code' => $this->getStatusCode(),
     ...
     * @return mixed
     */
    public function respondNotFoundWithData($message = 'Not Found', array $data = [])
    {
        $data["code"]    = 400;
    ...
    public function respondNotFoundWithRight($message = 'Not Found', array $rights = [])
    {
        // $data["code"]    = 404;
        // $data["message"] = $message;
        // return $this->respond($data);
...
//  getAll()
    ...
    public function formatPaginationObject($pagination, $data)
    {
        ...
        return [
            ...
            "meta" => [
                "pagination" => [
                    ...
                    "total_pages"  => (int) $pagination->lastPage(),
                    "links"        => [
